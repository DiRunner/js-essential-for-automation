 ...
 * 
 * @usecase
 * You want to set an environment variable so you can acess anywhere in your project
 * 
 * @scenario
 * 1. To set and environment variable at runtime (decide which environment to run the test)
 ...
 * 2. Set an environment vvariable via command line
